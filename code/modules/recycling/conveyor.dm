...
/obj/machinery/conveyor/underground/entrance/auto
	processing_flags = START_PROCESSING_ON_INIT

/obj/machinery/conveyor/underground/entrance/auto/Initialize(mapload, newdir)
	. = ..()
	set_operating(TRUE)

/obj/machinery/conveyor/underground/entrance/auto/update()
	. = ..()
	if(.)
		set_operating(TRUE)
...
/obj/machinery/conveyor/underground/exit/auto
	processing_flags = START_PROCESSING_ON_INIT

/obj/machinery/conveyor/underground/exit/auto/Initialize(mapload, newdir)
	. = ..()
	set_operating(TRUE)

/obj/machinery/conveyor/underground/exit/auto/update()
	. = ..()
	if(.)
		set_operating(TRUE)

/obj/machinery/conveyor/underground/entrance/conveyable_enter(datum/source, atom/movable/convayable)
	SIGNAL_HANDLER
	convayable.abstract_move(get_turf(linked_conveyor))
